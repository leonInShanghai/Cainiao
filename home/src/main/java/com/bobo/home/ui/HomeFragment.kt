...
import com.bobo.home.HomeViewModel
import com.bobo.home.R
import com.bobo.home.databinding.FragmentHomeBinding
import com.bobo.home.net.*
import com.bobo.home.ui.adapter.BannerAdapter
import com.bobo.home.ui.adapter.HomeAdapter
import com.bobo.service.network.*
...
class HomeFragment : BaseFragment() {
    ...
    override fun initData() {
        ...
        viewmodel.apply {
            ...
            liveHomeList.observerKt { homedatas ->
                // Log.d("yyy", homedatas.toString())
                homedatas ?: return@observerKt //如果返回的是空就结束
